...
class CommentServiceImplTest {
    ...
    void setUp() {
        ...
        // Setup test user
        testUser = new UserResponseDto(10L, "testuser", "test@example.com", "USER", true, UUID.randomUUID());
    }
    ...
    class CreateCommentTests {
        ...
        void createComment_ForTask_ShouldCreateSuccessfully() {
            ...
            UserResponseDto user20 = new UserResponseDto(20L, "user20", "user20@example.com", "USER", true, UUID.randomUUID());
            UserResponseDto user30 = new UserResponseDto(30L, "user30", "user30@example.com", "USER", true, UUID.randomUUID());
    ...
    class UpdateCommentTests {
        ...
        void updateComment_WhenAuthorized_ShouldUpdateSuccessfully() {
            ...
            // Mock project members to include mentioned users
            UserResponseDto user40 = new UserResponseDto(40L, "user40", "user40@example.com", "USER", true, UUID.randomUUID());
            UserResponseDto user50 = new UserResponseDto(50L, "user50", "user50@example.com", "USER", true, UUID.randomUUID());
    ...
    class GetCommentRepliesTests {
        ...
        void getCommentReplies_ShouldReturnReplies() {
            ...
            when(userManagementService.getUserById(20L)).thenReturn(
                new UserResponseDto(20L, "replyuser", "reply@example.com", "USER", true, UUID.randomUUID()));
