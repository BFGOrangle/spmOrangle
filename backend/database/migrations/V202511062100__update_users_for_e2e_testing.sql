...
SET
    ...
    role = 'MANAGER',
    cognito_user_id = '69ca95fc-90a1-7075-9c7d-3e9a5dff231d',
...
SET
    ...
    role = 'MANAGER',
    cognito_user_id = '394ae54c-f041-70dd-53c3-24cfc3abe446',
...
SET
    ...
    role = 'HR',
    cognito_user_id = '79aa85fc-e021-709a-85b2-fb77b6c327b3',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = '096a454c-c071-70c8-172a-bbc28059e0e9',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = '99aa35cc-80e1-70d5-7def-0f48b583b38e',
...
SET
    ...
    role = 'MANAGER',
    cognito_user_id = '69ea85dc-80e1-70d4-ff48-d6344d863a76',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = '497ab54c-2061-70b0-94f9-199a84c5aabe',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = 'b9ca655c-30e1-70cf-8a67-eea05f6ca28b',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = '292a751c-5001-7097-77a2-02e18c1f98ec',
...
SET
    ...
    role = 'STAFF',
    cognito_user_id = '094a556c-5031-702f-45a2-8e7db25735f6',
...
-- Verify the updates
SELECT id, username, email, role, cognito_user_id, department_id, is_active
FROM users
