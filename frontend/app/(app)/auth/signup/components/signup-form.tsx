"use client";
import { AtSign, Key, ArrowRight, User, Loader2 } from "lucide-react";
...
export default function SignUpForm() {
  ...
  async function handleSignUp(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await userManagementService.signUp(bodyData);

      toast("User Created Successfully", {
        description: `User ${username} created successfully! Please check your email to confirm your account.`,
      });

      // Redirect to confirmation page - user will need to confirm their email
